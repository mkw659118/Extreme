...
int BackwardPassCut::IterateInternal(const SLSTM_DTYPE_R *R_t, // [H*4,H]
...
int BackwardPassCut::Run(const int steps, const SLSTM_DTYPE_R *R_t,
                         const SLSTM_DTYPE_B *b, const SLSTM_DTYPE_S *s,
                         const SLSTM_DTYPE_S *ds_new, SLSTM_DTYPE_R *dR,
                         SLSTM_DTYPE_B *db, SLSTM_DTYPE_S *ds,
