...
from data_provider.DS_abilene_multi_mask import DS
from exp.exp_model_net_baseline_multi import Model
...
def run(config):
    ...
    if not hasattr(config, "draw_root"):
        setattr(config, "draw_root", "./draw_multi")
