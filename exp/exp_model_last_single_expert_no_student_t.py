...
from modules.RMF_last_single_expert_no_student_t import ExtremeLSTMMemo
...
from exp.exp_base_last_single_expert_no_student_t import BasicModel
...
class Model(BasicModel):
    def __init__(self, config):
        ...
        elif config.model == 'extreme_lstm_memo_single_expert_no_student_t':
