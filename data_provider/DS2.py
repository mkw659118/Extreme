...
class DS2:
    ...
    def read_dataset(self):
        ...
        d0 = data_prob30[:, 0].reshape(-1, 1)
        d1 = data_prob30[:, 1].reshape(-1, 1)
        d2 = data_prob30[:, 2].reshape(-1, 1)
        
        data_prob3 = np.concatenate((d0, d1), 1)
        data_prob3 = np.concatenate((data_prob3, d2), 1)
    ...
    def val_dataloader(self):
        ...
        d0 = gmm_prob30[:, 0].reshape(-1, 1)
        d1 = gmm_prob30[:, 1].reshape(-1, 1)
        d2 = gmm_prob30[:, 2].reshape(-1, 1)
