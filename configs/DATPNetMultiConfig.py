...
@dataclass
class DATPNetMultiConfig(NetConfig):
    model: str = 'datp_net_multi'
    enc_in: int = 864
    dec_in: int = 144
    out_dim: int = 144
    target_dim: int = 144
    target_cols: str = 'all'
    data_file: str = 'Abilene_12_12_3000_T3000_flat144.csv'
    draw_root: str = './draw_multi'
    state_prior_value_groups_per_channel: int = 3
    num_experts: int = 4
    top_k_experts: int = 2
    retrieval_num: int = 2
